...
output_dir = fullfile(root_dir, 'outputs','derivatives','test_vox222','derivatives');
preproc_dir = fullfile(root_dir, 'outputs','derivatives', 'test_vox222','derivatives','bidspm-preproc');
