...
output_dir = fullfile(root_dir, 'outputs','derivatives','test_vox222');

%% define subjects and tasks to preprocess
%subject_label = {''}; % ALL SUBJECTS FROM RAW
subject_label = 'sighted'; % ONLY BLIND GROUP
...
%% does preproc without Slice Timing Correction, trying to use [2 2 2] voxel size for normalization!
