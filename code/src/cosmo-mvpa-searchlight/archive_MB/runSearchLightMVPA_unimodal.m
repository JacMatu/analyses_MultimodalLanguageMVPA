...
opt.dir.rois = fullfile(opt.dir.root, 'outputs', 'derivatives', 'cpp_roi');
...
% subject_label = {'01'}; %#ok<*NASGU>

opt.taskName = 'audVisMotSpatialFreq';

opt.cosmomvpa.modalities = {'auditory', 'visual', 'fullMotionAudVis'};

% define the 4D maps to be used
opt.cosmomvpa.funcFWHM = 0;

% define the exact path for the results from stats
opt.dir.statsTask = ['task-audVisMotSpatialFreq_space-MNI152NLin2009cAsym_FWHM-' num2str(opt.cosmomvpa.funcFWHM) '_node-mvpaBlockAverage'];
