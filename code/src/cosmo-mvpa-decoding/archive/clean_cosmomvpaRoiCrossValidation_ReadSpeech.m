...
function clean_cosmomvpaRoiCrossValidation_ReadSpeech(opt)
...
for iSub = 1:numel(opt.subjects)
    ...
    %opt.query.label = opt.cosmomvpa.ROIlabel; %maybe in the future to only
    %pick ROIs specified in opt? 
                ...
                for iConditionToTest = 1:length(conditionsToTest)
                    ...
                    for iModality = 1:numel(opt.cosmomvpa.modalities)
                        ...
                        ConfMatName = fullfile(opt.cosmomvpa.pathOutput, ...
                            ...
                            '_classification-', conditionsToTest{iConditionToTest}, ...
                            '_mvpa_ConfMat.mat' ]);
