...
decodTitle = 'VWFAcrossmodal_3classes';

decodingConditions = {'trainRead_testSpeech', 'trainSpeech_testRead'};
...
nbRowsInAccu = 4; % HARDCODED: NB ROI * NB MODALITIES OR CONDITIONS
...
% why no permutations in crossmodal? 
...
accu = accuGroup;
    ...
    savefileMat = fullfile(pathOutput, ...
        ['stats', '_', 'group_' group, '_featureRatio-', num2str(featureRatio), '_smooth-', num2str(smooth), '_ffx-', im, '_', datestr(now, 'yyyymmddHHMM'), '.mat']);
