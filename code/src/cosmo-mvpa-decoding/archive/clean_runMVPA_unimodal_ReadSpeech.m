...
opt.cosmomvpa.ROIlabel = 'lexVWFA'; %changed from 'MT' other labels to test: aVWFA, cVWFA, pVWFA, perVWFA
...
clean_cosmomvpaRoiCrossValidation_ReadSpeech(opt) % ADJUSTED?
